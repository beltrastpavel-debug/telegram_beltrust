...
def handle_callback(call):
    ...
    if data == "employees":
        ...
        try:
            ...
            bot.edit_message_text("🟢 Активные сотрудники:", chat_id, call.message.message_id, parse_mode="HTML", reply_markup=markup)
        ...
        markup.row(telebot.types.InlineKeyboardButton("⬅️ Назад", callback_data="menu"))
        bot.edit_message_text("💸 Выберите категорию расхода:", chat_id, call.message.message_id, parse_mode="HTML", reply_markup=markup)
        ...
        try:
            ...
            bot.edit_message_text("👤 Кому выдаем аванс?", chat_id, call.message.message_id, parse_mode="HTML", reply_markup=markup)
        except Exception as e:
            bot.send_message(chat_id, f"Ошибка: {e}")
